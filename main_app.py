...
janela = Tk()
janela.title("Personal Budget App")
...
app_ = Label(frameCima, text="Orçamento", compound=LEFT, padx=5, relief=FLAT, anchor=NW, font='Verdana 20', bg=co1,
             fg=co4)
app_.place(x=0, y=0)
...
# Frame Meio -----------------------------------------------------
l_valor_quantia = Label(frameMeio, text="Renda mensal após impostos?", height=1, anchor=NW, font="Ivy 10", bg=co11,
                        fg=co4)
...
botao_calcular = Button(frameMeio, command=calcular, anchor=NW, text=" Calcular".upper(), overrelief=RIDGE,
                        font="Ivy 9", bg=co1, fg=co0)
botao_calcular.place(x=150, y=40)

# Frame Baixo -----------------------------------------------------
l_nome = Label(frameBaixo, text="Seus números de 50% 30% 20%:", padx=10, width=35, height=1, anchor=NW,
               font="Verdana 10", bg=co3, fg=co1)
...
# Total Quer
l_total_quer = Label(frameBaixo, text="Luxos: ", height=1, anchor=E, font="Verdana 10", bg=co9, fg=co0)
...
# Total Poupança
l_total_poupanca = Label(frameBaixo, text="Poupança e Investimentos:", height=1, anchor=E, font="Verdana 10", bg=co9,
                         fg=co0)
